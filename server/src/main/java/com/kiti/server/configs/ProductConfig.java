...
public class ProductConfig {
    ...
    CommandLineRunner commandLineRunner(ProductDAO productDAO) {
        ...
        List<Product> sampleProducts = List.of(
                ...
                new Product("LG OLED C1 Series 65” Alexa Built-in 4k Smart TV (3840 x 2160), 120Hz Refresh Rate, AI-Powered 4K, Dolby Cinema, WiSA Ready, Gaming Mode (OLED65C1PUB, 2021)", "Electronics", 2693000, 9, LocalDate.of(2019, 4, 6), 4., "https://m.media-amazon.com/images/I/916NVBBT0mS._AC_SL1500_.jpg", "LG", 143),
                ...
                new Product("SAMSUNG Galaxy S21 Ultra 5G Factory Unlocked Android Cell Phone 128GB", "Cell phones", 1219000, 33, LocalDate.of(2021, 8, 7), 4.5, "https://m.media-amazon.com/images/I/61O45C5qASL._AC_SL1000_.jpg", "Samsung", 1924),
                new Product("Beats Solo³ Wireless On-Ear Headphones - Apple W1 Chip - Rose Gold with AppleCare+ Bundle", "Electronics", 2900000, 80, LocalDate.of(2019, 3, 1), 4.0, "https://m.media-amazon.com/images/I/41kdNA1wnNL._AC_.jpg", "Beats", 1726),
                new Product("Samsung 55-inch TU-7000 Series Class Smart TV | Crystal UHD - 4K HDR", "Electronics", 9589000, 19, LocalDate.of(2021, 1, 3), 4.5, "https://m.media-amazon.com/images/I/71qqCWuXuYL._AC_SL1000_.jpg", "Samsung", 151),
